...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteHelper = new SQLiteHelper(this, "FoodBD.sqlite", null, 1);
        ...
        choose_b.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == REQUEST_CODE_GALLARY && requestCode == RESULT_OK && data != null){
    ...
    private void init(){
        ...
        choose_b = (Button) findViewById(R.id.choose_b);
        add_b = (Button) findViewById(R.id.add_b);
        list_b = (Button) findViewById(R.id.list_b);
